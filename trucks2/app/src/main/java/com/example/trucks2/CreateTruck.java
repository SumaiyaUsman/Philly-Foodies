    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                com.example.trucks2.Foodtruck foodtruck = new com.example.trucks2.Foodtruck(foodTruckName.getText().toString(), location.getText().toString(), cuisine.getText().toString());
                db.truckDao().insertAll(foodtruck);
                startActivity(new Intent(CreateTruck.this, com.example.trucks2.MainActivity.class));
            }
        });
    }
}
